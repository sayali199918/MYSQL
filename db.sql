...
select first_name,last_name,employees.department_ID, department_name from 
...
select b.employee_id , Mgr.Last_name,a.manager_id,Emp.Last_name from employees , employees a
...
select comp.first_name, comp.last_name,comp.hire_date from employees Sort, employees comp where comp.hire_date > sort.hire_date and sort.last_name = 'Jones';
...
select employees.Department_ID,Department_name,First_name,Last_name from employees,departments
